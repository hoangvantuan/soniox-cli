...
| Vai trò            | Label trong repo  | Nghĩa                                       |
| ------------------ | ----------------- | ------------------------------------------- |
...
| `ready-for-agent`  | `ready-for-agent` | Đã đặc tả đủ, agent chạy AFK được            |
| `ready-for-human`  | `ready-for-human` | Cần người thật làm                           |
| `wontfix`          | `wontfix`         | Sẽ không xử lý                               |

Cả năm label đều đã tồn tại trên repo.

Khi một skill nhắc tới vai trò (ví dụ "gắn label AFK-ready"), dùng chuỗi label ở cột thứ hai.

## Tạo lại nếu thiếu

Nếu một label bị xóa, tạo lại bằng:
...
Kiểm tra: `gh label list`. Nếu một skill cần label chưa tồn tại, tạo nó trước rồi mới gắn, đừng gắn label khác thay thế.
